...
<tr>
    ...
    <td><input type="text" class= "edit" name ="${rub.idRubro}" style="width: 40px;" onkeypress="return numbersOnly(this, event);" value= "1" /></td><%-- cantidad --%>  
...
<td><input type="text" class= "edit" name="${rub.idRubro}" style="width: 40px;" onkeypress="return numbersOnly(this, event);" value="${mat.coefStdMat}"  /></td> <%--mat.coefStdMat--%>
...
<c:forEach items="${rub.manoDeObra}" var="mo">
    <tr >
        ...
        <td> <input type="text" class= "edit" name = "${rub.idRubro}" style="width: 40px;" onkeypress="return numbersOnly(this, event);" value= "${mo.coefStdMO}"/></td>  <%--mo.coefStdMO--%>
